#LIST OF SOME EXTENSIONS BY MIMETYPE
MIMES = {
    ...
    "application/octet-stream": ['bin', 'bpk', 'buffer', 'deploy', 'dist', 'distz', 'dms', 'dump', 'elc', 'img', 'lrf', 'mar', 'msm', 'msp', 'pkg', 'so'],
    ...
    "application/vnd.uoml+xml": ['uo', 'uoml'],
